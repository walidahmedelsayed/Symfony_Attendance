 ...
 */
class Branch extends \AppBundle\Entity\Branch implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Branch' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Branch' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Branch' . "\0" . 'city', '' . "\0" . 'AppBundle\\Entity\\Branch' . "\0" . 'tracks'];
        }
